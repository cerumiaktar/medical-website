            ...
            <div className="hero bg-[#0341C9] h-[300px] rounded-xl">
                <div className="hero-content text-center">
                    <div className="max-w-3xl">
                        ...
                        <div className="bg-white py-6 px-6 rounded-lg grid grid-cols-1 md:grid-cols-4 gap-6">
                            {/* Doctor Dropdown */}
                            ...
                            {/* Department Dropdown */}
                            <div className="dropdown dropdown-start w-full">
                                <div tabIndex={0} role="button" className="btn m-1">Department <span><MdArrowDropDown /></span></div>
                                <ul tabIndex="-1" className="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
                                    <li><a>Item 1</a></li>
                                    <li><a>Item 2</a></li>
                                </ul>
                            ...
                            {/* Hospital Dropdown */}
                            <div className="dropdown dropdown-start w-full">
                                <div tabIndex={0} role="button" className="btn m-1">Hospital <span><MdArrowDropDown /></span></div>
                                <ul tabIndex="-1" className="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
                                    <li><a>Item 1</a></li>
                                    <li><a>Item 2</a></li>
                                </ul>
                            ...
                            <div className="w-full">
                                <button className="btn"><MdOutlineSearch />Like</button>
                            </div>
                        </div>
                    </div>
                </div>
