...
const ChooseUs = () => {
    return (
        <div className="mb-12">
            <h1 className="text-2xl font-medium text-center dark:text-black mb-6">Why Choose Us</h1>
            <div className="flex flex-col md:flex-row gap-6">
                <div className="w-full md:w-6/12">
                    <div className="card mb-6  bg-[#FFF5F5] border-l-8 border-[#CF0A0A] ">
                        <div className="card-body">
                            <h2 className="card-title dark:text-black">Qualified Doctors</h2>
                    ...
                    <div className="card bg-[#F0FAFF] border-l-8 border-[#146CA5]">
                        <div className="card-body">
                            <h2 className="card-title dark:text-black">Comprehensive Medical Services</h2>
                ...
                <div className="w-full md:w-6/12">
                    <div className="card mb-6 bg-[#F3FFFE] border-l-8 border-[#02AB98]">
                        <div className="card-body">
                            <h2 className="card-title dark:text-black">Patient-Centric Care</h2>
                    ...
                    <div className="card  bg-[#FFF6FE] border-l-8 border-[#B2009B]">
                        <div className="card-body">
                            <h2 className="card-title dark:text-black">Trusted Reputation</h2>
